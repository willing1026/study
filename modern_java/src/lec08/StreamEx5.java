...
//        System.out.println("single stream time : " + (System.currentTimeMillis() - start2));
        ...
        //core 개수 설정
        System.setProperty("java.util.concurrent.ForkJoinPool.common.parallelism", "3"); // 0 ~ 3 : 4개
        ...
        Arrays.asList(1, 2, 3, 4, 5, 6, 7, 8)
                ...
                .forEach(i -> System.out.println(i));
        System.out.println("parallelism stream time : " + (System.currentTimeMillis() - start3));
    }
